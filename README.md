...
ФИО уже вынесено в переменные:

- backend: `AUTHOR_FULL_NAME` в `backend/.env.example` и `app/config.py`;
- frontend: `NEXT_PUBLIC_AUTHOR_FULL_NAME` в `frontend/.env.local.example`.
